...
export type Scalars = {
  ...
  LandingPageContentDynamicZoneInput: { input: any; output: any; }
...
export type ComponentContentGallery = {
  ...
  title?: Maybe<Scalars['String']['output']>;
  type: Enum_Componentcontentgallery_Type;
};


export type ComponentContentGalleryImagesArgs = {
...
export type ComponentContentLink = {
  __typename?: 'ComponentContentLink';
...
export enum Enum_Componentcontentgallery_Type {
  Grid = 'grid',
  Slider = 'slider'
}
...
export type GenericMorph = ComponentContentBlockContent | ComponentContentGallery | ComponentContentLink | ComponentSeoSeo | I18NLocale | LandingPage | Product | ProductCategory | Test | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type LandingPage = {
  ...
  content?: Maybe<Array<Maybe<LandingPageContentDynamicZone>>>;
  createdAt?: Maybe<Scalars['DateTime']['output']>;
...
export type LandingPageContentDynamicZone = ComponentContentBlockContent | ComponentContentGallery | ComponentContentLink | Error;
...
export type LandingPageInput = {
  content?: InputMaybe<Array<Scalars['LandingPageContentDynamicZoneInput']['input']>>;
...
export type Product = {
  __typename?: 'Product';
  createdAt?: Maybe<Scalars['DateTime']['output']>;
  product_category?: Maybe<ProductCategoryEntityResponse>;
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  slug: Scalars['String']['output'];
  title?: Maybe<Scalars['String']['output']>;
  updatedAt?: Maybe<Scalars['DateTime']['output']>;
